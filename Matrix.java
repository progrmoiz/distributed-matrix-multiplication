 ...
 */
  ...
  /**
   * Given two square matrices, this function will return the product of the two
   * matrices using the
   * Strassen algorithm
   *
   * @param mtx1 The first matrix
   * @param mtx2 The matrix that is being multiplied by mtx1
